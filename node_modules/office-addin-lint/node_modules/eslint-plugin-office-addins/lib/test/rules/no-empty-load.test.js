...
const no_empty_load_1 = __importDefault(require("../../src/rules/no-empty-load"));
const ruleTester = new rule_tester_1.RuleTester({
    parser: '@typescript-eslint/parser',
});
ruleTester.run('no-empty-load', no_empty_load_1.default, {
    valid: [
        {
            code: `
...
//# sourceMappingURL=no-empty-load.test.js.map